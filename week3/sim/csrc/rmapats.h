...
typedef struct hybridSimInfoT {
    ...
    void * I961;
    U  * I962;
    struct hybridSimReferrerData * I963;
    struct hybridSimReferrerData * I965;
} hybridSimInfoT;
...
struct qird {
    ...
    UP  * I315;
    UP  * I316;
    struct daidirInfo * I317;
    struct vcs_tftable * I319;
    U  I321;
    UP  * I322;
    UP  * I323;
    U  I324;
...
typedef struct {
    ...
    unsigned long long I1065;
    unsigned long long I1066;
    unsigned long long I1067;
...
typedef struct {
    ...
    U  I1092;
    U  I1093;
    HsimSignalMonitor  * I1094;
    HsimPostNbaClkMonitor  * I1095;
    RP  I1096;
    RmaTimeStamp64  I655;
    U  I1097;
    RmaTimeStamp64  I1098;
    U  I1099;
    UB  I1100 :1;
    UB  I1101 :1;
    UB  I1102 :1;
...
typedef struct {
    U  I658;
    U  I666;
    RmaThreadSchedCompiledLoads  * I1144;
...
typedef struct {
    ...
    U  I1146;
    RmaIbfIp  * I1147;
    RmaThreadSchedCompiledLoadsArr  I1148;
} RmaJaguarIbnSchedCg;
typedef struct {
    RP  I1149;
} RmaRootCbkCg;
...
typedef struct {
    ...
    RP  I1235;
    RmaEblk  I670;
    RemoteDbsedLoad   I1236[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I1000;
    struct TableAssign_ * I753;
    U  I59;
    U  I1238 :1;
    U  I1239 :1;
    U  I1240 :2;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I1000;
    struct TableAssignLayoutOnClk_ * I753;
    U  I59;
    U  I1238 :1;
    U  I1239 :1;
    U  I1240 :2;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I1000;
    struct TableAssignLayoutOnClkOpt_ * I753;
    U  I740;
    U  I1238 :1;
    U  I1239 :1;
    U  I1240 :2;
    ...
    RmaSeqPrimOutputOnClkOpt  I1253;
    RmaSeqPrimOutputEblkData  I1258;
...
typedef struct RmaNonEdgeLoadHdr1_ {
    ...
    UB  I1341;
    US  I1078;
    RmaNonEdgeLoadData1  * I1210;
    RmaNonEdgeLoadData1  * I753;
    RP  I1235;
    void * I1211;
} RmaNonEdgeLoadHdr1;
...
typedef struct RmaChildClockPropList1_ {
    RmaChildClockProp  * I1210;
    RmaChildClockProp  * I753;
...
void  rmaPropagate0_f_simv_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1499, U  did);
...
void  rmaPropagate1_f_simv_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1499, U  did);
...
void  rmaPropagate2_f_simv_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1499, U  did);
