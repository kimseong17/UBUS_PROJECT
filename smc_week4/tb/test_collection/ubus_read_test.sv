class ubus_read_test extends uvm_test;
    ...
    function void build_phase(uvm_phase phase);
        ...
        uvm_config_db#(uvm_object_wrapper)::set(this, "env.slave_env.slave_agent.sequencer.run_phase", "default_sequence", ubus_slave_sequence::type_id::get());
    endfunction
...
//	phase.drop_objection(this);
	`uvm_info("READ_TST", "Run Phase Check", UVM_MEDIUM)
    endtask
